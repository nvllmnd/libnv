...
#define buff_foreach_iter(_self_, _iter_name_) for (__typeof(*(_self_))* _iter_name_ = _self_; _iter_name_ < buff_end((_self_)); _iter_name_++)

#define buff_foreach(_self_) buff_foreach_iter(_self_, iter)


#define buff_foreach_iter_const(_self_, _iter_name_) for (const __typeof(*(_self_))* _iter_name_ = _self_; _iter_name_ < buff_end((_self_)); _iter_name_++)
...
#define vec_write(self, out, out_len) (buff_write(pcast(Buff, (self)), (out), (out_len) * (i32)sizeof(__typeof(*(self)))))
...
#define vec_foreach_iter(_self_, _iter_name_) for (__typeof(*(_self_))* _iter_name_ = _self_; _iter_name_ < vec_end((_self_)); _iter_name_++)

#define vec_foreach(_self_) vec_foreach_iter(_self_, iter)


#define vec_foreach_iter_const(_self_, _iter_name_) for (const __typeof(*(_self_))* _iter_name_ = _self_; _iter_name_ < vec_end((_self_)); _iter_name_++)

...
#define bit_lite_VERSION \
  bit_STRINGIFY(bit_lite_MAJOR) "." bit_STRINGIFY(bit_lite_MINOR) "." bit_STRINGIFY(bit_lite_PATCH)
...
#define bit_USES_STD_BIT \
  ((bit_CONFIG_SELECT_BIT == bit_BIT_STD) || ((bit_CONFIG_SELECT_BIT == bit_BIT_DEFAULT) && bit_HAVE_STD_BIT))
...
struct uint_by_size<8> {
  typedef std11::uint8_t type;
};
template <>
struct uint_by_size<16> {
  typedef std11::uint16_t type;
};
template <>
struct uint_by_size<32> {
  typedef std11::uint32_t type;
};
#if bit_CPP11_OR_GREATER
template <>
struct uint_by_size<64> {
...
// AppleClang  7.0.0  __apple_build_version__ ==  7000172  bit_COMPILER_APPLECLANG_VERSION ==  700  (Xcode 7.0, 7.0.1)
// (LLVM 3.7.0) AppleClang  7.0.0  __apple_build_version__ ==  7000176  bit_COMPILER_APPLECLANG_VERSION ==  700
// (Xcode 7.1)                 (LLVM 3.7.0) AppleClang  7.0.2  __apple_build_version__ ==  7000181
// bit_COMPILER_APPLECLANG_VERSION ==  702  (Xcode 7.2, 7.2.1)          (LLVM 3.7.0) AppleClang  7.3.0
// __apple_build_version__ ==  7030029  bit_COMPILER_APPLECLANG_VERSION ==  730  (Xcode 7.3) (LLVM 3.8.0)
// AppleClang  7.3.0  __apple_build_version__ ==  7030031  bit_COMPILER_APPLECLANG_VERSION ==  730  (Xcode 7.3.1)
// (LLVM 3.8.0) AppleClang  8.0.0  __apple_build_version__ ==  8000038  bit_COMPILER_APPLECLANG_VERSION ==  800
// (Xcode 8.0)                 (LLVM 3.9.0) AppleClang  8.0.0  __apple_build_version__ ==  8000042
// bit_COMPILER_APPLECLANG_VERSION ==  800  (Xcode 8.1, 8.2, 8.2.1)     (LLVM 3.9.0) AppleClang  8.1.0
// __apple_build_version__ ==  8020038  bit_COMPILER_APPLECLANG_VERSION ==  810  (Xcode 8.3) (LLVM 3.9.0)
// AppleClang  8.1.0  __apple_build_version__ ==  8020041  bit_COMPILER_APPLECLANG_VERSION ==  810  (Xcode 8.3.1)
// (LLVM 3.9.0) AppleClang  8.1.0  __apple_build_version__ ==  8020042  bit_COMPILER_APPLECLANG_VERSION ==  810
// (Xcode 8.3.2, 8.3.3)        (LLVM 3.9.0) AppleClang  9.0.0  __apple_build_version__ ==  9000037
// bit_COMPILER_APPLECLANG_VERSION ==  900  (Xcode 9.0)                 (LLVM 4.0.0?) AppleClang  9.0.0
// __apple_build_version__ ==  9000038  bit_COMPILER_APPLECLANG_VERSION ==  900  (Xcode 9.1) (LLVM 4.0.0?)
// AppleClang  9.0.0  __apple_build_version__ ==  9000039  bit_COMPILER_APPLECLANG_VERSION ==  900  (Xcode 9.2)
// (LLVM 4.0.0?) AppleClang  9.1.0  __apple_build_version__ ==  9020039  bit_COMPILER_APPLECLANG_VERSION ==  910
// (Xcode 9.3, 9.3.1)          (LLVM 5.0.2?) AppleClang  9.1.0  __apple_build_version__ ==  9020039
// bit_COMPILER_APPLECLANG_VERSION ==  910  (Xcode 9.4, 9.4.1)          (LLVM 5.0.2?) AppleClang 10.0.0
// __apple_build_version__ == 10001145  bit_COMPILER_APPLECLANG_VERSION == 1000  (Xcode 10.0, 10.1) (LLVM 6.0.1?)
// AppleClang 10.0.1  __apple_build_version__ == 10010046  bit_COMPILER_APPLECLANG_VERSION == 1001
// (Xcode 10.2, 10.2.1, 10.3)  (LLVM 7.0.0?) AppleClang 11.0.0  __apple_build_version__ == 11000033
// bit_COMPILER_APPLECLANG_VERSION == 1100  (Xcode 11.1, 11.2, 11.3)    (LLVM 8.0.0?)
...
#else
template <class T>
struct is_trivial : std11::true_type {};
#endif
...
#else
template <class T>
struct is_trivially_copyable : std11::true_type {};
#endif
...
#else
template <class T>
struct is_copy_constructible : std11::true_type {};
#endif
...
#else
template <class T>
struct is_unsigned : std11::true_type {};
#endif
...
struct is_same : std11::true_type {};
#endif
...
/*constexpr*/
bit_ENABLE_IF_R_(To, ((sizeof(To) == sizeof(From)) && std11::is_trivially_copyable<From>::value &&
...
inline bit_constexpr std11::uint8_t byteswap_(std11::uint8_t value) bit_noexcept { return value; }

inline /*bit_constexpr*/ std11::uint16_t byteswap_(std11::uint16_t value) bit_noexcept { return bit_byteswap16(value); }

inline /*bit_constexpr*/ std11::uint32_t byteswap_(std11::uint32_t value) bit_noexcept { return bit_byteswap32(value); }

#if bit_CPP11_OR_GREATER

inline /*bit_constexpr*/ std11::uint64_t byteswap_(std11::uint64_t value) bit_noexcept { return bit_byteswap64(value); }
...
template <class T bit_ENABLE_IF_(std11::is_unsigned<T>::value)>
...
#if bit_CPP11_OR_GREATER
             ? T{1}
             : bit_ceil_impl(x, std20::same_as<T, decltype(+x)>{});
#else
             ? T(1)
             : bit_ceil_impl(x, std11::true_type());
#endif
}
...
inline std11::uint8_t to_big_endian_(std11::uint8_t v, little_endian_type) bit_noexcept { return v; }

inline std11::uint16_t to_big_endian_(std11::uint16_t v, little_endian_type) bit_noexcept { return bit_byteswap16(v); }

inline std11::uint32_t to_big_endian_(std11::uint32_t v, little_endian_type) bit_noexcept { return bit_byteswap32(v); }

#if bit_CPP11_OR_GREATER

inline std11::uint64_t to_big_endian_(std11::uint64_t v, little_endian_type) bit_noexcept { return bit_byteswap64(v); }
...
inline std11::uint8_t to_little_endian_(std11::uint8_t v, big_endian_type) bit_noexcept { return v; }

inline std11::uint16_t to_little_endian_(std11::uint16_t v, big_endian_type) bit_noexcept { return bit_byteswap16(v); }

inline std11::uint32_t to_little_endian_(std11::uint32_t v, big_endian_type) bit_noexcept { return bit_byteswap32(v); }

#if bit_CPP11_OR_GREATER

inline std11::uint64_t to_little_endian_(std11::uint64_t v, big_endian_type) bit_noexcept { return bit_byteswap64(v); }

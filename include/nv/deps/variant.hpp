...
struct TX : T {
  ...
  template <class U>
  inline bool operator==(U const&) const {
    return false;
  }
  template <class U>
  inline bool operator<(U const&) const {
...
#if variant_CPP11_OR_GREATER
  variant_STATIC_ASSERT(detail::typelist_size<variant_types>::value > 0,
                        "Template parameter type list of variant can not be empty.");
  variant_STATIC_ASSERT(detail::typelist_size<variant_types>::value <= variant_CONFIG_MAX_TYPE_COUNT,
                        "Exceeding configured number of alternative types.");
  // variant_STATIC_ASSERT( !detail::disjunction<std::is_reference<Types>...>::value, "Variant can not hold reference
  // types. Maybe use std::reference_wrapper?"); variant_STATIC_ASSERT(
  // !detail::disjunction<std::is_array<Types>...>::value, "Variant can not hold array types.");
#endif

 public:
  // 19.7.3.1 Constructors

  variant() variant_noexcept_op(std::is_nothrow_default_constructible<T0>::value) : type_index(0) {
#if variant_CPP11_OR_GREATER
    variant_STATIC_ASSERT(std::is_default_constructible<T0>::value,
                          "First type in variant must be default constructible to allow default construction of "
                          "variant (e.g. use monostate).");
#endif
    new (ptr()) T0();
  }
  ...
  template <typename T,
            typename Traits = detail::value_traits<T, variant_types> variant_REQUIRES_B(
                Traits::is_valid && !std::is_same<variant<variant_types>, typename Traits::value_type>::value)>
  ...
  variant(variant const& other) : type_index(variant_npos_internal()) {
  ...
  template <typename T,
            typename Traits = detail::value_traits<T, variant_types> variant_REQUIRES_B(
                Traits::is_valid && !std::is_same<variant<variant_types>, typename Traits::value_type>::value)>
  variant& operator=(T&& t) noexcept(std::is_nothrow_constructible<typename Traits::target_type, T&&>::value &&
...
#if variant_CPP11_OR_GREATER
      noexcept(std::is_nothrow_move_constructible<T0>::value && std17::is_nothrow_swappable<T0>::value &&
...
inline variant_constexpr bool holds_alternative(
...
template <class R, class T0, class T1, class T2, class T3, class T4, class T5, class T6, class T7, class T8, class T9,
          class T10, class T11, class T12, class T13, class T14, class T15>
inline variant_constexpr R& get(variant<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, T15>& v,
...
template <class R, class T0, class T1, class T2, class T3, class T4, class T5, class T6, class T7, class T8, class T9,
          class T10, class T11, class T12, class T13, class T14, class T15>
inline variant_constexpr R const& get(
...
template <std::size_t K, class T0, class T1, class T2, class T3, class T4, class T5, class T6, class T7, class T8,
          class T9, class T10, class T11, class T12, class T13, class T14, class T15>
inline variant_constexpr14 typename variant_alternative<
...
template <class T, class T0, class T1, class T2, class T3, class T4, class T5, class T6, class T7, class T8, class T9,
          class T10, class T11, class T12, class T13, class T14, class T15>
inline variant_constexpr typename std11::add_pointer<T>::type get_if(
    variant<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, T15>* pv,
    nonstd_lite_in_place_type_t(T) = nonstd_lite_in_place_type(T)) variant_noexcept {
  return (pv->index() ==
          variant<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, T15>::template index_of<T>())
             ? &get<T>(*pv)
             : variant_nullptr;
...
template <class T, class T0, class T1, class T2, class T3, class T4, class T5, class T6, class T7, class T8, class T9,
          class T10, class T11, class T12, class T13, class T14, class T15>
inline variant_constexpr typename std11::add_pointer<const T>::type get_if(
...
template <std::size_t K, class T0, class T1, class T2, class T3, class T4, class T5, class T6, class T7, class T8,
          class T9, class T10, class T11, class T12, class T13, class T14, class T15>
inline variant_constexpr typename std11::add_pointer<typename variant_alternative<
...
get_if(variant<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, T15>* pv,
       nonstd_lite_in_place_index_t(K) = nonstd_lite_in_place_index(K)) variant_noexcept {
  return (pv->index() == K) ? &get<K>(*pv) : variant_nullptr;
}

template <std::size_t K, class T0, class T1, class T2, class T3, class T4, class T5, class T6, class T7, class T8,
          class T9, class T10, class T11, class T12, class T13, class T14, class T15>
inline variant_constexpr typename std11::add_pointer<const typename variant_alternative<
    K, variant<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, T15> >::type>::type
...
inline variant_constexpr auto visit(Visitor const& v, V const&... vars) ->
...
inline variant_constexpr14 bool operator==(
  ...
  if (v.index() != w.index())
    ...
    return detail::Comparator<variant<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, T15> >::equal(v,
                                                                                                                     w);
}
...
struct hash<nonstd::variant<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, T15> > {
  std::size_t operator()(nonstd::variant<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, T15> const& v)

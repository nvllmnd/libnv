...
#define ptr_nonnull(_ptr) cast(typeof_ptr(_ptr), ptr_nonnull_((const void*)(_ptr))) /*((typeof_ptr(_ptr))(ptr_nonnull_((const void*)(_ptr))))*/
...
#define pexpect(_p, _msg) cast(typeof_ptr(_p), ptr_expect_((const void*)(_p), (_msg))) /*(typeof_ptr(_p))(ptr_expect_((_p), (_msg))))*/
#endif
